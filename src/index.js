...
let userID = "c94f8883-12a1-48d7-b646-a0b887371f13";
...
const cn_hostnames = ['']; let CDNIP = 'www.visa.com.sg';

// http_ip
let [IP1, IP2, IP3, IP4, IP5, IP6, IP7] = [
	'www.visa.com', 'cis.visa.com', 'africa.visa.com',
	'www.visa.com.sg', 'www.visaeurope.at', 'www.visa.com.mt', 'qa.visamiddleeast.com'
];

// https_ip
let [IP8, IP9, IP10, IP11, IP12, IP13] = [
	'usa.visa.com', 'myanmar.visa.com', 'www.visa.com.tw',
	'www.visaeurope.ch', 'www.visa.com.br', 'www.visasoutheasteurope.com'
];

// http_port
let [PT1, PT2, PT3, PT4, PT5, PT6, PT7] = ['80', '8080', '8880', '2052', '2082', '2086', '2095'];

// https_port
let [PT8, PT9, PT10, PT11, PT12, PT13] = ['443', '8443', '2053', '2083', '2087', '2096'];
...
function setupProxy(env) {
	const { proxyip } = env;
	userID = env.uuid || userID;

	function parseProxy(ip) {
		if (ip.includes(']:')) {
			let lastColonIndex = ip.lastIndexOf(':');
			return [ip.slice(0, lastColonIndex), ip.slice(lastColonIndex + 1)];
	...
	if (proxyip) {
		[proxyIP, proxyPort] = parseProxy(proxyip);
	} else {
		[proxyIP, proxyPort] = parseProxy(proxyIP);
